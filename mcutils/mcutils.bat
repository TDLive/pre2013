...
if "%1"=="craftbukkit" (
	if "%2"=="get" (
		...
		cd C:\bukkit
		wget http://cbukk.it/craftbukkit.jar -O craftbukkit.jar
...
if "%1"=="vanilla" (
	if "%2"=="get" (
		...
		cd C:\vanilla
		wget https://s3.amazonaws.com/MinecraftDownload/launcher/minecraft_server.jar -O minecraft_server.jar
