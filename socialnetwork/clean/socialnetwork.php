...
<form action='socialnetwork.php' method='post'><i>Text <b>to post</b>:</i><input type="text" name="post"><input type='hidden' name='lid' value='1'><input type='hidden' name='p' value='lpost'><input type='hidden' name='loggedin' value='1'><input type='hidden' name='user' value="<?php echo $user; ?>"><input type='submit' value='Post'></form><br>
<?php
if($user == "@adm"){
?>
...
<input type='submit' value='Example App'></form>
-->
<br><br>
